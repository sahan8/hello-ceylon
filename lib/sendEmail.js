      ...
      html: `
        ...
        <head>
          <style>
            ...
            .header { background: #102A43; padding: 40px; text-align: center; }
            ...
            .tagline { color: #102A43; font-style: italic; margin-top: 10px; }
          </style>
        </head>
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <div class="booking-card">
                ...
                <div class="booking-row">
                  ...
                  <div class="booking-value" style="color: #102A43; font-size: 20px; font-weight: 600;">$${booking.totalPrice}</div>
                </div>
              </div>
      ...
      html: `
        ...
        <head>
          <style>
            ...
            .booking-value { color: #14211B; font-size: 16px; margin-top: 5px; }
            .admin-link { display: inline-block; background: #1F5A78; color: #FFFFFF; padding: 15px 30px; text-decoration: none; border-radius: 4px; margin-top: 20px; }
          </style>
        </head>
        <body>
          <div class="container">
            ...
            <div class="content">
              <h2 style="color: #102A43;">New booking received!</h2>
              <div class="booking-card">
                <div class="booking-row">
